# ==============================================================================
# Register Project 4 Real-Time FileWatcher as a Permanent Windows Task
# Task Name: Stock_Project4_Realtime_Watcher
...
$ScriptPath = "C:\Users\adi5s\OneDrive\Documents\STOCK\project4_invest_analyzer\watch_and_push.ps1"
